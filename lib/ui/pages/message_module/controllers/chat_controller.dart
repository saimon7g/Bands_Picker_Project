...
class ChatController extends GetxController implements GetxService{
 ...
 final  _messages = <ChatMessage>[
    ChatMessage(name: "Niaz", message: "Could you please tell me your",
      notSeenMessageAmount: 3, imagePath:'assets/images/eattt.png',
        dateTime: DateTime.now() ),

   ChatMessage(name: "Angshuman", message: "Could you please tell me your",
       notSeenMessageAmount: 1, imagePath:'assets/images/Elli5.png',
       dateTime: DateTime.now() ),

   ChatMessage(name: "Saimon", message: "Could you please tell me your",
       notSeenMessageAmount: 0, imagePath:'assets/images/Ellipsededd.png',
       dateTime: DateTime.now() ),
